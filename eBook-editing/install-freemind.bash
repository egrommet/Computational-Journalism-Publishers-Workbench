...
curl -L http://downloads.sourceforge.net/project/freemind/freemind-unstable/1.0.0_Beta9/freemind-bin-max-1.0.0_Beta_9.zip > freemind-bin-max-1.0.0_Beta_9.zip
cd freemind
unzip ../freemind-bin-max-1.0.0_Beta_9.zip
popd
